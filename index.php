		   		...
		   		<div class="col-twelve">
		   			...
		   			<div id="counter">
			  			...
			  			<div class="bottom-text">
				  			...
				  			<p>
							Simple inQ is dope - heres some cool facts about us
				  			</p>			  				
			  			</div>			  						  			   			
						...
						<div class="tab-entry">
							...
							<div class="row tab-entry-intro">
					   		<div class="col-twelve with-bottom-line">
					   			...
					   			<p class="lead">Want to know the details of when we launch? Let us know your email so we can let you know.</p>
   ...
   <footer>
   	...
   	<div class="footer-bottom">
			...
			<div class="footer-logo">
					<img src="images/simple_footer2.png" alt="">				
			</div>

   		<div class="copyright">
		     	<span>© Copyright Simple inQ 2017.</span> 
		   </div>		   
